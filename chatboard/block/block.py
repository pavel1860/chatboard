...
from chatboard.utils.function_utils import is_overridden
...
class Block:
    ...
    def hash(self) -> str:
        ...
        """
        from chatboard.versioning.block_storage import compute_block_hash
    ...
    def model_dump(self) -> dict[str, Any]:
        ...
        from chatboard.utils.type_utils import type_to_str
        result = {
    ...
    def model_load(cls, data: dict[str, Any]) -> Block:
        ...
        """
        from .schema import BlockSchema, BlockListSchema, BlockList
        from chatboard.utils.type_utils import str_to_type
