...
from chatboard.algebra.vectors.batch_vectorizer import BatchVectorizer
from chatboard.utils.model_utils import is_list_type, unpack_list_model
...
if TYPE_CHECKING:
    ...
    from chatboard.model.versioning import Branch, Turn, Partition
    from chatboard.model.query_filters import QuerySetProxy
