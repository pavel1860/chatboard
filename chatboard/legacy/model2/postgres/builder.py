...
from chatboard.utils.db_connections import PGConnectionManager, SyncPGConnectionManager
...
if TYPE_CHECKING:
    from chatboard.model.postgres.namespace import PostgresNamespace, PgFieldInfo
...
class SQLBuilder:
    ...
    #     from chatboard.model2.postgres.sql_blocks import create_table_block
    ...
    def create_table(cls, name: str, *fields: "PgFieldInfo"):
        """Create a table for a namespace"""
        from chatboard.model.postgres.sql_blocks import create_table_block
