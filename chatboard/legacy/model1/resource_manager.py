...
# from chatboard.artifact_log.artifact_log2 import BaseArtifact, create_artifact_table_for_model
...
if TYPE_CHECKING:
    from chatboard.model.model import Model, ForeignKey, RelationBlueprint
