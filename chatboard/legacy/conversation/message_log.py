...
from chatboard.conversation.models import Branch, Message, MessageBackend, Session, Turn
from chatboard.conversation.protocols import BaseProto
...
class UserManager:
    def __init__(self, backend):
        from chatboard.conversation.models import UserBackend, MessageBackend
