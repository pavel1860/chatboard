...
from chatboard.model.base.types import VersioningStrategy
from chatboard.model.postgres2.queries import insert_query, update_query
...
class PgNamespace(BaseNamespace["Model", PgFieldInfo]):
    ...
    def insert(self, data: dict[str, Any]) -> "PgInsertSet[Model]":
        from chatboard.model.postgres2.pg_query_set import PgInsertSet
        return PgInsertSet(self).insert(**data)
    
    
    def update(self, id: Any, data: dict[str, Any]) -> "PgUpdateSet[Model]":
        from chatboard.model.postgres2.pg_query_set import PgUpdateSet
