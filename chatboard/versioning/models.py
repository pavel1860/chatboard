...
from chatboard.model.base.types import ArtifactKind
from chatboard.model.db_types import Tree

from ..model.sql2.expressions import Raw
from ..model.sql2.relations import RawRelation

from chatboard.utils.type_utils import SerializableType, UnknownType, deserialize_value, serialize_value, type_to_str, str_to_type, type_to_str_or_none
...
class Branch(Model):
    ...
    def recursive_query(cls, branch_id: int) -> "SelectQuerySet":
        from chatboard.model.sql2.pg_query_builder import PgQueryBuilder, select
