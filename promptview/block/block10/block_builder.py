...
class BlockBuilder:
    ...
    def append(self, value: Block | str | Chunk, copy: bool = True) -> Block:
        """
        ...
        if isinstance(value, Block):
            ...
            self.block.append_child(value)
        return self.block

    def append_chunk(self, chunk: Chunk) -> Block:
        """
    ...
    def finish(self, postfix: str | list[Chunk] | None = None) -> Block:
        """
...
class StreamingBlockBuilder:
    ...
    def open_root(self, content: str | list[Chunk] | None = None) -> Block:
        """
    ...
    def append(self, value: str | Chunk) -> Block:
        """
    ...
    def close_view(self, postfix: str | list[Chunk] | None = None) -> Block:
        """
